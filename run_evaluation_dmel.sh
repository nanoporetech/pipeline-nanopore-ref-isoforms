...
GFF_URL="http://ftp.ensembl.org/pub/release-99/gff3/drosophila_melanogaster/Drosophila_melanogaster.BDGP6.28.99.chr.gff3.gz"
...
GFF="$DATA_DIR/Drosophila_melanogaster.BDGP6.28.99.chr.gff3"
